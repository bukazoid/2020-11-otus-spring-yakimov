...
var Books = /*#__PURE__*/function (_Component) {
  ...
  function Books() {
    ...
    _defineProperty(_assertThisInitialized(_this), "model", Books.getModel("Book", ["id", "title", "author", "actions"]));
  ...
  _createClass(Books, [{
    ...
    value: function render() {
      ...
      var rows = data.map(function (book) {
        ...
        if (book.author.genres) {
          book.author.genres.map(function (genre) {
            genres += genre.name + "<br/";
          });
        }
...
//# sourceMappingURL=main.bc3f81eb7f2f57473ef7.hot-update.js.map