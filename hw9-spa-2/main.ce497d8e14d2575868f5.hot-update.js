...
var Books = /*#__PURE__*/function (_Component) {
  ...
  function Books() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDelete", function (book) {
      var id = book.id;
      Object(_common_Tools__WEBPACK_IMPORTED_MODULE_3__["doFetch"])("/api/books/" + id, "DELETE", id).then(_common_Tools__WEBPACK_IMPORTED_MODULE_3__["handleApiError"]).then(function () {
...
//# sourceMappingURL=main.ce497d8e14d2575868f5.hot-update.js.map