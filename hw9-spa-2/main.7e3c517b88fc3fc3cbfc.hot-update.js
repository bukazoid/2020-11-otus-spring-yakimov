...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-bootstrap-table2-filter'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../../../model/common/GridProperty'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-bootstrap-table-next/dist/react-bootstrap-table2.min.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-bootstrap-table2-filter/dist/react-bootstrap-table2-filter.min.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-bootstrap-table2-paginator/dist/react-bootstrap-table2-paginator.min.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var Grid = /*#__PURE__*/function (_React$Component) {
  ...
  function Grid() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getDefaultPagingOptions", function () {
      return {
        paginationSize: 4,
        pageStartIndex: 1,
    ...
    _defineProperty(_assertThisInitialized(_this), "getDefaultFilterOptions", function () {
      return !(function webpackMissingModule() { var e = new Error("Cannot find module 'react-bootstrap-table2-filter'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
        placeholder: " "
      }); //TODO need to add a right text for each placeholder
    });
  ...
  _createClass(Grid, [{
    ...
    value: function render() {
      ...
      var paginationOptions = this.getDefaultPagingOptions();
      var filter = this.getDefaultFilterOptions();
      ...
      var emptyDataMessage = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-intl'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
        id: "common.no-table-data"
      }); //TODO emptyDataMessage should be in text format

      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-bootstrap-table-next'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
        keyField: "id",
        data: data,
        columns: headers,
        striped: true,
        ...
        filter: !(function webpackMissingModule() { var e = new Error("Cannot find module 'react-bootstrap-table2-filter'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(),
...
_defineProperty(Grid, "propTypes", {
  model: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.instanceOf(!(function webpackMissingModule() { var e = new Error("Cannot find module '../../../model/common/GridProperty'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()))).isRequired,
...
//# sourceMappingURL=main.7e3c517b88fc3fc3cbfc.hot-update.js.map