...
var Books = /*#__PURE__*/function (_Component) {
  ...
  function Books() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDelete", function (book) {
      if (!_this.state.selected) {
        return;
      }

      var id = _this.state.selected.geo_area_id;
      Object(_common_Tools__WEBPACK_IMPORTED_MODULE_3__["doFetch"])("/rest/tapgeo/", "DELETE", id).then(_common_Tools__WEBPACK_IMPORTED_MODULE_3__["handleApiError"]).then(function () {
    ...
    value: function render() {
      ...
      var rows = data.map(function (book) {
        ...
        var deleteLink = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          href: "#",
          title: "delete",
          onClick: _this2.confirmDelete(book)
        }, "delete");
...
//# sourceMappingURL=main.5cf9c304dea035fd56dc.hot-update.js.map