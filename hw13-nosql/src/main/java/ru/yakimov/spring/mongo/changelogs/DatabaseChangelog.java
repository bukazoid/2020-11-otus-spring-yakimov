package ru.yakimov.spring.mongo.changelogs;
...
public class DatabaseChangelog {
	...
	@ChangeSet(order = "001", id = "dropDb", author = "frozen")
	public void dropDb(MongoDatabase db) {
		db.drop();
	}
	
	@ChangeSet(order = "002", id = "insertAdmin", author = "bukazoid")
	public void insertPushkin(UserRepository repository) {
		repository.save(new User("admin", "admin", "ROLE_ADMIN"));
	}

	@ChangeSet(order = "003", id = "insertAuthors", author = "bukazoid")
	...
	@ChangeSet(order = "004", id = "insertGenres", author = "bukazoid")
	...
	@ChangeSet(order = "005", id = "insertBooks", author = "bukazoid")
