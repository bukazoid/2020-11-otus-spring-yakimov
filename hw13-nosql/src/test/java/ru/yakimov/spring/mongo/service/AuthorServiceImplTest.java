...
import ru.yakimov.spring.mongo.service.AuthorService;
import ru.yakimov.spring.mongo.service.AuthorServiceImpl;
...
public class AuthorServiceImplTest {
	...
	void shouldGetById() {
		Author expected = new Author("11", "Me");
		when(authorRepo.findById(eq("11"))).thenReturn(Optional.of(expected));

		Author author = authorService.read("11");
